...
public abstract class Controller {
	...
	protected Controller(List<Service> servicesList) {
	...
	public void run(int minute, Result resultSim) {
		...
		this.sumBatteryGenerator += resultSim.getBatteryUnderCapacityLoss();
		...
		this.maxBatteryGenerator = (resultSim.getBatteryUnderCapacityLoss() > this.maxBatteryGenerator) ? resultSim.getBatteryUnderCapacityLoss() : this.maxBatteryGenerator;
		...
		this.avgBatteryGenerator = this.sumBatteryGenerator / this.waitTime;
